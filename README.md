...
*The latest version of Helm is maintained by the CNCF - in collaboration with Microsoft, Google, Bitnami and the Helm contributor community."* - [What is Helm? - helm.sh](https://www.helm.sh/)
...
* **License:** [Apache 2.0](https://choosealicense.com/licenses/apache-2.0/)
* **Legal Requirements:** [Google Corporate CLA](https://cla.developers.google.com/about/google-corporate) /
